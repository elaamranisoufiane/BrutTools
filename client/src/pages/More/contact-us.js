    ...
    return (
        ...
        <>
            ...
            <Helmet>
                ...
                <meta name="description" content="Contact BrutTools Team for support & other queries." />
            </Helmet>
                ...
                <div className="container bg-white p-10 rounded-lg mx-auto flex-col">
                    <div className="">
                        ...
                        <div className="md:p-8">
                            ...
                            <p className="mb-6">
                                We’d love to hear from you! At BrutTools, we are committed to providing top-notch support and ensuring you have the best experience with our tools.
                            </p>

                            <p className="mb-6">
                                <b>Email Support</b>: Have questions or need assistance? Our dedicated support team is here to help. Email us at support [javatp01@gmail.com], and we’ll get back to you as soon as possible.
                            </p>

                            <p className="mb-6">
                                <b>Feedback</b>: Your feedback is invaluable to us. Whether you have suggestions for new features or improvements, we’re always eager to hear your thoughts. Please share your feedback via email or our social media channels.
                            </p>

                            <p className="mb-6">
                                <b>Social Media</b>: Stay connected with us! Follow us on social media for the latest updates, tips, and special offers:
                            </p>
                            ...
                            <p className="mb-6">
                                <b>Business Enquiries</b>: For partnership opportunities, collaborations, or other business-related inquiries, please contact us at support [javatp01@gmail.com].
                            </p>

                            <p className="mb-6">
                                We’re here to support you every step of the way. Thank you for choosing BrutTools!
                            </p>
                        </div>
