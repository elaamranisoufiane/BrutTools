    ...
    },
    {
      ...
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M21 6l-6 6 6 6V9H3V6h18zM3 15v-3H1v9h2v-6h14v6h2v-9h-2v3z" />
        </svg>
      ),
    }, {
      ...
      svg: (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M7 12h10M7 15h10M7 9h10M5 3h14v18H5V3zM4 6h16M4 18h16" />
        </svg>
      ),
    }, {
      ...
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M3 3h4v4H3V3zm0 6h4v4H3v-4zm0 6h4v4H3v-4zm6-6h4v4H9v-4zm0 6h4v4H9v-4zm6-6h4v4h-4v-4zm6 6h-4v4h4v-4zm0-6h-4v4h4V9zM3 15h4v4H3v-4zm12-6h4v4h-4V9zm6 6h-4v4h4v-4z" />
        </svg>
      ),
    }, {
      ...
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M21 12H3m0 0v9h18v-9zm-6 3l6-6-6-6M9 12l-6-6 6-6" />
        </svg>
      ),
    },
    {
      ...
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M12 19.5v-15M5.5 12l6.5 6.5L18.5 12 12 5.5 5.5 12z" />
        </svg>
      ),
    },
    {
      ...
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M9 12H7a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h2M17 12h2a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-2M12 4v16M15 7l-3 3-3-3M12 11v-4" />
        </svg>
      ),
    }, {
      ...
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M10 14l2-2-2-2M14 10l-2 2 2 2M17 10h-6a4 4 0 0 0-4 4v6a4 4 0 0 0 4 4h6a4 4 0 0 0 4-4v-6a4 4 0 0 0-4-4z" />
        </svg>
      ),
    },
    {
      ...
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M17 13l4 4M3 13l4 4M7 13l4 4M5 8h14M5 5h14M5 11h14M5 16h14M5 19h14" />
        </svg>
      ),
    },
    {
      ...
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M8 7h8M8 11h8M8 15h8M5 5v14h14V5H5z" />
        </svg>
      ),
    },
    {
      ...
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M12 20l-4-4h8l-4 4zM12 4l-8 8h4l4-4l4 4h4l-8-8zM20 8h-4l-4-4v4h4l4 4z" />
        </svg>
      ),
    },
  ];
    ...
    <>
      ...
      <main className={`max-w-3/4 h-full flex flex-col items-center min-h-screen ${false ? 'bg-gray-900 text-white' : 'bg-white text-slate-900'}`}>
        <div className="container">
          ...
          <section className="min-h-screen  flex flex-col items-center justify-center">
            ...
            <div className="max-w-4xl w-full space-y-8">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <a href="#tools" className="bg-gray-800 text-white px-6 py-3 rounded-md hover:bg-gray-900 transition duration-300">
                  Discover All Tools &darr;
                </a>
              </div>
          ...
          <section id='tools' className="min-h-screen flex flex-col items-center justify-center">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-20">
              {Tools.map((tool) => (
                <div key={tool.toolUrl} className="flex items-center justify-center bg-white shadow-lg rounded-lg p-4 transform transition-transform duration-300 hover:scale-110">
                  <a href={tool.toolUrl} className='items-center justify-center'>
                    <p className="text-gray-600 text-2xl font-bold">{tool.toolName}</p>
                    <p className="text-2xl font-semibold text-gray-600 flex items-center justify-center p-2"> {tool.svg} </p>
                  </a>
                </div>
              ))}
            </div>
